...
class PyNode:
    ...
    def get_lib_dtype_spec(self):
        if self.type in PyNode.all_op_dtype_spec:
        ...
        def show_output_min_max_scale(id):
            ...
            try:
                for out in self.outputs:
                    ...
                    OPT_DEBUG(
                        f'\t\t[{out.min.item(): <.6f}, {out.max.item(): <.6f}, {out.running_mean: <.6f}, {out.running_std: <.6f}, '
