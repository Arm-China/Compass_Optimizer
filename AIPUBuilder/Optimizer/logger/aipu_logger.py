...
def _logger_stderr_write(s):
    try:
        from AIPUBuilder._C import _core
        return _core._logger_stderr_write(s)
...
def _logger_stdout_write(s):
    try:
        from AIPUBuilder._C import _core
        return _core._logger_stdout_write(s)
    except Exception as e:
        pass
...
def _set_logger_file(logfile, errfile):
    try:
        from AIPUBuilder._C import _core
        return _core._set_logger_file(logfile, errfile)
    except Exception:
        pass
    global ERRFILE
    global LOGFILE
...
def increase_error():
    ...
    try:
        from AIPUBuilder._C import _core
        return _core._increase_error_count()
    except Exception:
        ERROR_COUNT += 1
...
def get_error_count():
    try:
        from AIPUBuilder._C import _core
        return _core._get_error_count()+ERROR_COUNT
    except Exception:
        pass
    return ERROR_COUNT
