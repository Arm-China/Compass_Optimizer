    ...
    if config.enable_pass_detect_inf_mask_nodes:
        ...
        for i, n in enumerate(graph.nodes):
            ...
            if n.type == OpType.Constant:
                if torch.is_floating_point(n.constants['weights'].betensor):
                    n.constants['weights'].betensor = n.constants['weights'].betensor.float()
                else:
                    n.constants['weights'].betensor = n.constants['weights'].betensor.int()
